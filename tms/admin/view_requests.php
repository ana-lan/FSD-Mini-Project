                    ...
                    <tbody>
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {       
                          ?>    
                          <tr>
                            <td width="120"><?php echo htmlentities($result->RequestId);?></td>
                            <td width="50"><?php echo htmlentities($result->UserEmail);?></td>
                            <td width="50"><?php echo htmlentities($result->RequestDate);?></td>
                            <td width="50"><?php echo htmlentities($result->PackageId);?></td>
                            <td width="50"><?php echo htmlentities($result->NoOfkids);?></td>
                            <td width="50"><?php echo htmlentities($result->NoOfadults);?></td>
                          </tr>
                          <?php
                        }
                      }?>
